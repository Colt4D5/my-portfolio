    ...
    <section id="technologies" className="section technologies_container">
      <div className="inner tech_inner">
        ...
        <div className="skills">
          ...
          <Skill comfort="30" lang="PHP 8" url="https://img.icons8.com/ios-filled/250/787CB5/php-logo.png" index="4" />
          <Skill comfort="65" lang="TypeScript" url="https://img.icons8.com/color/250/000000/typescript.png" index="5" />
          ...
          <Skill comfort="25" lang="Bootstrap" url="https://img.icons8.com/color/250/000000/bootstrap.png" index="9" />
